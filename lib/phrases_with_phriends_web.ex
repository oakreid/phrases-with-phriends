defmodule PhrasesWithPhriendsWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      ...
      alias PhrasesWithPhriendsWeb.Router.Helpers, as: Routes
    end
  end

  def view do
    quote do
      use Phoenix.View, root: "lib/phrases_with_phriends_web/templates",
                        namespace: PhrasesWithPhriendsWeb
